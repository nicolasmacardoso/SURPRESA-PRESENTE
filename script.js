...
function tapHeart () {
    ...
    document.querySelector('header').innerHTML = `Toque ${20 - count} vezes no coração para ganhar um presente!`;
    ...
    if (count == 20) {
        ...
        setTimeout(() => {
            document.querySelector('.presente-container').style.transform = 'translateY(280px)';            
        }, 10);
        document.querySelector('.heart-btn').style.transform = 'scale(0)';
        document.querySelector('.heart-btn').style.transition = 'all 0.5s ease-in-out';
        document.querySelector('header').innerHTML = `Parabéns! Você ganhou um presente!`;
